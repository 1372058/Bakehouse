...
@section('mainContent')
	<h1>Merchant Product View</h1>
		...
		<div>
			<a href="/">Menu</a>
			<a >|</a>
			<a href="/merchant_product/showbyid">cats</a>
	...
	<table class="table table-striped">
		...
		<tr>
			...
			<td><a href="merchant_product/{{$merchant_product->id}}/edit">Edit</a>&nbsp;|&nbsp;<a href="merchant_product/{{$merchant_product->id}}">Delete</a> </td>
		</tr>
		@endforeach
		</tbody>
	</table>
